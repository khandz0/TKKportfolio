...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Ensure these values match your EmailJS account
    const serviceId = "tkk.0626"; // Replace with your EmailJS Service ID
    const templateId = "template_djnpece"; // Replace with your EmailJS Template ID
    const userId = "5rYxLD8tcYZBrI8hk"; // Replace with your EmailJS Public Key
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors disabled:bg-gray-400"
              disabled={isSending}
            >
              {isSending ? (
                "Sending..."
